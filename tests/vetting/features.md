...
790 of 968 assertion rows agree with the tree.

| verdict | rows | meaning |
|---|---:|---|
| `agree` | 790 | the claim and the tree say the same thing |
...
| `row` | 144 | the case named in `test_name` asserts this feature, at this row's kind; its configuration is unchecked, the family declaring no recipe reader |

## Families with no scanner

**178 of 968 rows (18%) cannot be checked against the tree at all.** These families have an
